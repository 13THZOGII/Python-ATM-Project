...
def main():
    ...
    if islemler == "2":
        ...
        if ka not in [sozluk1["isim1"], sozluk1["isim2"], sozluk1["isim3"]]:
 ...
 def main2():
    ...
    if islemlerr == "6":
        ...
        if ka == sozluk1["isim1"]:
            if withdraw <= sozluk1["bakiyeA"]:
                ...
                print("Hesabından {} TL Para Çekilmiştir. Mevcut Hesap Bakiyeniz {}".format(withdraw,
                                                                                             sozluk1["bakiyeA"]) + " TL")
                e = input("İşleme Devam Etmek İster misiniz? (Evet Hayır)")
                if e.lower() == "evet":
                    main2()
                ...
                if e.lower() == "evet":
                    ...
                    main()
 elif islemlerr == "3":  # TRANSFER İŞLEMİ
        if ka == sozluk1["isim1"]:
            ...
            elif menu == "1":  # AHMET, ZEYNEP'E PARA ATARSA;
            ...
            if menu == "5":
                ...
                if e.lower() == "evet":
                    ...
                    main()
         elif menu == "1":  # ZEYNEP, AHMET'E PARA ATARSA;
                eft = int(input("Lütfen Transfer Etmek İstediğiniz Bakiyeyi Giriniz: "))
                if eft <= sozluk1["bakiyeZ"]:
                    sozluk1["bakiyeZ"] -= eft
                    sozluk1["bakiyeA"] += eft
                    sozluk2[0]["eftZ"].append(
                        t + " Tarihinde Hesabınızdan " + str(eft) + " TL Para {}"
    ...
    if eft <= sozluk1["bakiyeZ"]:
        ...
        sozluk2[0]["eftZ"].append(
            ...
            " Adlı Kullanıcıya Transfer Edildi.".format(sozluk1["isim3"]))
        print("Hesabından {} TL Para, {} Adlı Kişiye Transfer Edilmiştir. "
              "Mevcut Hesap Bakiyeniz {}".format(eft, sozluk1["isim3"], sozluk1["bakiyeZ"]) + " TL")
        e = input("İşleme Devam Etmek İster misiniz? (Evet Hayır)")
        if e.lower() == "evet":
            main2()
        else:
